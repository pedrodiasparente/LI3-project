...
sgv: leitura.o clientNoBuy.o vendas.o userData.o main.o findProduct.o faturacao.o gestaoFilial.o catProdutos.o catClientes.o vendasProdMes.o querie4.o
	$(CC) $(CFLAGS) main.o leitura.o clientNoBuy.o vendas.o userData.o findProduct.o faturacao.o gestaoFilial.o catProdutos.o catClientes.o vendasProdMes.o querie4.o -o sgv $(LDLIBS)

main.o: clientNoBuy.h vendas.h leitura.h catProdutos.h catClientes.h faturacao.h gestaoFilial.h vendasProdMes.h querie4.h
...
querie4.o: querie4.c querie4.h faturacao.h catProdutos.h userData.h
	$(CC) $(CFLAGS) -c querie4.c $(LDLIBS)
