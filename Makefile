...
sgv: leitura.o clientNoBuy.o vendas.o userData.o main.o findProduct.o faturacao.o
	$(CC) $(CFLAGS) main.o leitura.o clientNoBuy.o vendas.o userData.o findProduct.o faturacao.o -o sgv $(LDLIBS)

main.o: clientNoBuy.h vendas.h leitura.h
	$(CC) $(CFLAGS) -c main.c $(LDLIBS)

leitura.o: vendas.h faturacao.h
